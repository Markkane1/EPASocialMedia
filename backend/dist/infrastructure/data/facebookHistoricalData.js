...
exports.FACEBOOK_DAILY_FOLLOWS = exports.FACEBOOK_DAILY_VISITS = exports.FACEBOOK_DAILY_LINK_CLICKS = exports.FACEBOOK_DAILY_INTERACTIONS = exports.FACEBOOK_DAILY_VIEWERS = exports.FACEBOOK_DAILY_VIEWS = exports.FACEBOOK_DATES_SHORT = exports.FACEBOOK_DATES_FULL = void 0;
exports.getFacebookHistoricalTrends = getFacebookHistoricalTrends;
exports.FACEBOOK_DATES_FULL = [
...
exports.FACEBOOK_DAILY_VIEWERS = [
...
exports.FACEBOOK_DAILY_INTERACTIONS = [
...
exports.FACEBOOK_DAILY_LINK_CLICKS = [
    5, 10, 8, 12, 10, 6, 4,
...
exports.FACEBOOK_DAILY_FOLLOWS = [
    20, 45, 25, 30, 22, 15, 12,
    48, 65, 40, 95, 160, 265, 180,
    110, 85, 82, 105, 150, 80, 72,
    68, 65, 50, 35, 18, 22, 21
];
function getFacebookHistoricalTrends() {
    return exports.FACEBOOK_DATES_FULL.map((d, i) => ({
        date: d,
        views: exports.FACEBOOK_DAILY_VIEWS[i],
        viewers: exports.FACEBOOK_DAILY_VIEWERS[i],
        reach: exports.FACEBOOK_DAILY_VIEWERS[i],
        impressions: Math.round(exports.FACEBOOK_DAILY_VIEWS[i] * 1.167), // Total impressions ~2.1M
        interactions: exports.FACEBOOK_DAILY_INTERACTIONS[i],
        linkClicks: exports.FACEBOOK_DAILY_LINK_CLICKS[i],
        visits: exports.FACEBOOK_DAILY_VISITS[i],
